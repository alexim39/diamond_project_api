...
export const COURSES = [
  {
    ...
    lessons: [
      ...
      lesson(
        'ipo-3',
        'Your first 30 days',
        'Welcome home, partner — you made the right decision, and you are not walking this road alone. Feeling excited and nervous at the same time is completely normal; every leader you admire started exactly where you are now. Your only job in the next 30 days is simple, visible basics. Week one: finish this orientation and the Quick Start Guide, write down 50 prospects, and book your onboarding session with your upline — your coach, not your boss. Weeks two to four: present the opportunity daily, follow up warmly, and log every touch in the CRM. A “no” today is not a “no” forever; rejection is redirection, and consistency beats intensity every time. Show up to the weekly training, ask questions shamelessly, and let your upline sit in on your first presentations. Momentum in month one predicts year one — and one year from now, you will be so glad you started today. The diamond in you is waiting to shine.',
